...
const topUpOptions = [
  { diamonds: 50, price: 7700 },
  { diamonds: 70, price: 9800 },
  { diamonds: 100, price: 14500 },
  { diamonds: 140, price: 19000 },
  { diamonds: 150, price: 21000 },
  { diamonds: 210, price: 28500 },
  { diamonds: 260, price: 35500 },
  { diamonds: 355, price: 47000 },
  { diamonds: 425, price: 56500 },
  { diamonds: 515, price: 69000 },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-yellow-50 to-yellow-200 p-4">
      <div className="max-w-4xl mx-auto text-center mb-6">
        ...
        <p className="text-gray-700 mt-2">100% Trusted & Legal | Prosses 5-10 Minutes</p>
        <p className="text-sm text-gray-500">Time: 09:30 - 22:30</p>
      </div>
